...
<p align="center">
  <a href="https://github.com/ibrhmucar/claude-usage-monitor/releases/latest">
...
1. Go to [**Releases**](https://github.com/ibrhmucar/claude-usage-monitor/releases/latest)
...
```bash
git clone https://github.com/ibrhmucar/claude-usage-monitor.git
...
**Easiest way:** Go to [claude.ai/settings/account](https://claude.ai/settings/account) — your Organization ID is displayed on this page.

**Alternative:** From the Network tab (same request as step 1), look at the request URL:
