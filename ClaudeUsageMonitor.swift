    ...
    private var settingsView: some View {
        VStack(alignment: .leading, spacing: 14) {
            VStack(alignment: .leading, spacing: 6) {
                ...
                SecureField("sk-ant-sid02-...", text: $monitor.sessionKey)
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                TextField("xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", text: $monitor.orgId)
                    .textFieldStyle(.roundedBorder).font(.system(size: 11, design: .monospaced))
            }
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("4. URL\u{2019}den: /organizations/XXXX-XXXX/usage").font(.system(size: 10)).foregroundColor(.secondary)
